...
-- Schema salonAuta
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `salonAuta` DEFAULT CHARACTER SET utf8 ;
USE `salonAuta` ;


-- -----------------------------------------------------
-- Table `salonAuta`.`marke`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `salonAuta`.`marke` (
...
-- -----------------------------------------------------
-- Table `salonAuta`.`modeli`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `salonAuta`.`modeli` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `kod` VARCHAR(125) NOT NULL DEFAULT ' ',
  `naziv` VARCHAR(125) NOT NULL DEFAULT ' ',
  `IDmarke` INT NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  INDEX `fk_modeli_marke_idx` (`IDmarke` ASC),
  CONSTRAINT `fk_modeli_marke`
    FOREIGN KEY (`IDmarke`)
    REFERENCES `salonAuta`.`marke` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = INNODB;
...
-- -----------------------------------------------------
-- Table `salonAuta`.`vrste`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `salonAuta`.`vrste` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `salonAuta`.`auti`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `salonAuta`.`auti` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `IDmodel` INT NOT NULL,
  `sifra` VARCHAR(45) NOT NULL DEFAULT ' ',
  `IDvrste` INT NOT NULL,
  `opis` VARCHAR(1000) NOT NULL,
  `cijena` DECIMAL NOT NULL,
  `slika` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_auti_modeli1_idx` (`IDmodel` ASC),
  INDEX `fk_auti_vrste1_idx` (`IDvrste` ASC),
  CONSTRAINT `fk_auti_modeli1`
    FOREIGN KEY (`IDmodel`)
    REFERENCES `salonAuta`.`modeli` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_auti_vrste1`
    FOREIGN KEY (`IDvrste`)
    REFERENCES `salonAuta`.`vrste` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = INNODB;
...
INSERT INTO `marke` (`id`, `kod`, `naziv`) VALUES
(1, 'ACURA', 'Acura'),
(2, 'ALFA', 'Alfa Romeo'),
(3, 'AMC', 'AMC'),
...
INSERT INTO `modeli` (`id`, `IDmarke`, `kod`, `naziv`) VALUES
...
INSERT INTO `vrste` (`id`, `naziv`) VALUES
(1, 'Gradski'),
(2, 'SUV'),
(3, 'Coupe'),
(4, 'Limuzina'),
...
ALTER TABLE auti
ADD arhiviraj TINYINT(1);

ALTER TABLE auti AUTO_INCREMENT = 1;

INSERT INTO auti (IDmodel, sifra, IDvrste, opis, cijena, slika, arhiviraj) VALUES
(451, '#112311231', 2, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s.', 150000, 'car1.jpg', 1),
(371, '#112234531', 8, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s.', 100000, 'car2.jpg', 1),
(476, '#189711231', 7, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s.', 250000, 'car3.jpg', 1),
(551, '#167875541', 4, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s.', 150000, 'car4.jpg', 0);

CREATE TABLE `salonauta`.`users` ( 
`id` INT NOT NULL AUTO_INCREMENT , 
...
(1, 'admin', '$2y$10$6sDTyEyCfQ6zyKigl4J2ROgI6ABYQ3Wj7g5SvTQQTa/r0TwOOli2W', 'Root', 1),
(2, 'korisnik', '$2y$10$XY0AouJ9fm64I3J./fxSRu.p6zTNyhJTVEWs099DYelD6AYEVu5oa', 'Mile', 0);
